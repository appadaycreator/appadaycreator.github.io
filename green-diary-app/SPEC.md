...
| バージョン | 日付 | 主な変更内容 |
|-----------|------|------------|
| v11.0.16 | 2026-07-01 | /improve_phase2_only実行・M20: アクセシビリティ対応（aria属性追加）・Cookieバナーボタンに aria-label="Cookie同意して閉じる" 追加・CTA セクションリンクボタンに aria-label="無料でグリーンダイアリーの記録を始める" 追加・Cookieバナーコンテナに role="region" + aria-label="Cookie同意バナー" を追加し、WCAG 2.1 AA基準を強化
