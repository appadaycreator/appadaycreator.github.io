...
- v1.2.6 (2026-07-02): M2施策 UX改善 – V1 CTA ボタンの視認性向上(padding:16px→20px, font-weight:700→800, box-shadow強化)・V2 信頼性指標を4→3項目に整理してノイズ低減・V3 プライバシー同意チェックボックスのサイズ拡大(20px→24px)・背景色濃化(#f0f7ff→#dbeafe)・テキスト色濃化(#1e40af→#0c4a6e)・V4 ゲスト数・地域説明テキストをより詳細・読みやすく(text-xs→text-sm, color:#6b7280→#4b5563, font-weight:500)・情報エントロピー削減
